...
public sealed class SetServiceActiveUseCase
{
    ...
    public SetServiceActiveUseCase(ICurrentUser currentUser, IShopRepository shops, IServiceRepository services, IUnitOfWork uow)
    {
    ...
    public async Task ExecuteAsync(Guid serviceId, bool isActive, CancellationToken ct)
    {
